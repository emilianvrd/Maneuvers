...
#### Drone
You've construct an artificial intelligence (or AI), a sophisticated program of self-motivated code that you can access for help in a variety of endeavors. This AI is the product of your own genius, far more advanced and complicated than any available for sale to consumers (though it might falls short of being truly self-aware), and only you know the secrets of its creation and operation. The drone has the following base statistics:

**Traits**: Construct\
**Size**: Small, Medium or Large (your choice)\
...
**HP**: 30; **Immunities**: Bleed, death effects, disease, drained, fatigue, mental, paralyzed, poison, unconcious\
**Speed**: 10m
...
- **Skilled** Your drone gains proficiency in a skill of your choice.
...
- **Vehicle** A creature that is at least one size smaller than the drone can ride atop of it
