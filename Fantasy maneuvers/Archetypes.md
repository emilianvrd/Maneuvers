# Archetypes
Archtypes determines most of what your character can do. You gain two archetypes at 1st level, and one more at 4th and 8th level. 
...
When you perfrom a Flourish with the Spell trait, you gain a +5 circumstance bonus to the damage. If you are a Magician, you gain a +6 circumstance bonus to the damage instead. In addition, you gain a Fighting move that deals damage.
...
When you perform a Fighting move with the Fire trait, you gain a +1 circumstance bonus to the damage. When you perform a Flourish with the Fire trait, you gain a +2 circumstance bonus to the damage, or a +3 bonus if you are a Magician. In addition, you learn a Fighting move with the Fire trait.
...
| d20 | Effect |
|---|---|
| 1 | You and every creature within 10m of you takes 3d10 damage of the same type as the Flourish you just performed. If the Flourish dealt multiple damage types, the GM determines randomly which one applies. If the Flourish did not deal damage, the damage is fire damage. |
...
| 20 | The Flourish becomes Empowered if it can be used three times per day. You don't expend all three uses of the Flourish and this ability applies even if you don't have three uses of the Flourish left. |

### Swimmer
You are an adept swimmer. You gain a swimming speed equal to your walking speed. If you already have a swimming speed, increase that speed by 10m instead. You also don't take any penalties for making Strikes while underwater.
